...
```gradle
dependencies {
  annotationProcessor 'com.uber.rib:rib-compiler-test:0.13.4'
  implementation 'com.uber.rib:rib-android:0.13.4'
  testImplementation 'com.uber.rib:rib-test:0.13.4'
}
```
