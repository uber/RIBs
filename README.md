...
```gradle
dependencies {
  annotationProcessor 'com.uber.rib:rib-compiler-test:0.15.3'
  implementation 'com.uber.rib:rib-android:0.15.3'
  testImplementation 'com.uber.rib:rib-test:0.15.3'
}
```
