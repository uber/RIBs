...
private constructor(
  ...
  companion object {
     ...
     */
    @JvmStatic
    fun createTrimMemoryEvent(trimMemoryType: Int): TrimMemory = TrimMemory(trimMemoryType)
     ...
     */
    @JvmStatic fun createNewIntent(intent: Intent): NewIntent = NewIntent(intent)
